...
import { OrenPlaygroundService } from './oren-playground.service';
// @ts-ignore
...
export class OrenPlaygroundComponent implements OnInit {
  ...
  constructor(
    ...
    private backendApiService: OrenPlaygroundService,
  ...
  testEndpoint(endpoint, successFunc = null, errorFunc = null) {
    const self = this;
    // this.backendApiService.getApiEndpoint(`/tests/${endpoint}`).subscribe(
    //   (res: any) => {
